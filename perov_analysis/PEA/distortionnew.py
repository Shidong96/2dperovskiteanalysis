	...
	for n in N:
            ...
            for c in C:
                ...
                if self.distance(c,n)<1.6 :
                    temp.append([c,n])
                    print (n[0]+c[0])/2,(n[1]+c[1])/2,(n[2]+c[2])/2
...
#            dangle.append((540-self.bondangle(pb,x1,x2)-self.bondangle(pb,y1,y2)-self.bondangle(pb,z1,z2))/3)
		...
		dangle.append(self.bondangle(pb,z1,i)-90)
		dangle.append(self.bondangle(pb,z2,i)-90)
	    dangle.append(self.bondangle(pb,x1,y1)-90)
	    dangle.append(self.bondangle(pb,x2,y2)-90)
	    dangle.append(self.bondangle(pb,x1,y2)-90)
	    dangle.append(self.bondangle(pb,x2,y1)-90)
	
	    distortion.append(math.sqrt(sum((i)**2 for i in dangle)/11))
...
#        print 'delta angle per octahedron:', dangle
	print 'new distortion:', distortion
	print 'average new distoriton:', np.mean(distortion)
        return excursion
